...
const CartClient = () => {
  ...
  if (!cartPrdcts || cartPrdcts.length == 0) {
    return <h1>Sepetinizde ürün bulunamadı</h1>; // Sepet boş ise bu mesajı göster
  }
  ...
  return (
    <div>
      <PageContainer>
        <div className="flex items-center text-center gap-3 border-b py-3">
        ...
        <div className="flex items-center justify-between gap-3 border-t my-5 py-5">
          <button
            onClick={() => removeCart()}
